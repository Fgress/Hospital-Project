...
- **FPS-R Scores:** Patients’ pain levels were rated using the Faces Pain Scales-Revised scale from 0 (no pain) to 10 (worst pain possible), offering a measurable discomfort level during IV insertion. This score determines the primary outcome, that is, the effectiveness of different treatment approaches.
...
**Secondary Objective 2: Does the Combination of Ametop with a Vapocoolant Spray Increase the Number of IV Insertion Attempts, Compared to Using Ametop Alone?**
...
p-value = $Pr(T > t)$ with degree of freedom = 221.

The *one-sided* confidence interval can be calculated through: $(\bar{x} - t_{221}\times\frac{s}{\sqrt{n}}, \infty)$.
