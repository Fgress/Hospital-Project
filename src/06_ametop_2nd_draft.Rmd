...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap = "Boxplots of Control and Study Group for the Full Dataset"}
# Read data
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap='Linear Regression Model for Control and Study Group'}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap = "Number of IV Attempts for Control and Study Group"}
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center', fig.cap = "Proportion of Observed Side Effects"}
